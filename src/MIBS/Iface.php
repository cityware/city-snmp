...
class Iface extends \Cityware\Snmp\MIB {
    ...
    public function returnFullData() {
        ...
        $aReturn['type_desc'] = $this->getSNMP()->translate($aInterface[self::OID_IF_TYPE], self::$IF_TYPES);
        ...
        $aReturn['oper_status_desc'] = $this->getSNMP()->translate($aInterface[self::OID_IF_OPER_STATUS], self::$IF_ADMIN_STATES);
     ...
     * value."
     *
     * @see \Cityware\Snmp\MIBS\System::uptime()
