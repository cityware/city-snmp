...
class SNMP {
     ...
     * @var \Cityware\Snmp\Cache The cache object to use
     */
     ...
     *
     * @param \Cityware\Snmp\Cache $c The cache to use
     * @return \Cityware\Snmp\SNMP For fluent interfaces
     */
